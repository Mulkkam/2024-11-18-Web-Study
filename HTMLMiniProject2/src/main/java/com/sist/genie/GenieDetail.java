...
public class GenieDetail extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GenieReplyDAO rdao=GenieReplyDAO.newInstance();
		List<GenieReplyVO> list=rdao.genieReplyListData(Integer.parseInt(mno));
		 
		out.println("<table class=table>");
		out.println("<tr>");
		out.println("<td>");
		for(GenieReplyVO rvo:list)
		{
			out.println("<table class=table>");
			out.println("<tr>");
			...
			if(rvo.getId().equals(id))
			{
				...
				out.println("<a href=GenieReplyInsert?mno="+mno+"&rno="+rvo.getRno()+" class=\"btn btn-xs btn-info\">삭제</a>");
			}
			out.println("</td>");	
			out.println("</tr>");
			out.println("<tr>");
			...
			out.println("<form method=post action=GenieReplyUpdate>");
		...
		{
			 out.println("<form method=post action=GenieReplyInsert>");
			 out.println("<table class=table>");
			 out.println("<tr>");
			 out.println("<td>");
